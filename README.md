...
2. Install the `Dedalix Beta` app. New updates in the Beta app are released periodically. You will receive a notification when the new updates are available.
...
- On iOS, access the `Dedalix Beta` app page in TestFlight and click **Stop Testing**.

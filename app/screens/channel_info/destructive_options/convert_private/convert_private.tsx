...
const messages = defineMessages({
    convertPrivateTitle: {
        ...
        defaultMessage: 'Convert {displayName} to a group chat?',
    },
    convertPrivateDescription: {
        id: 'channel_info.convert_private_description',
        defaultMessage: 'When you convert {displayName} to a group chat, history and membership are preserved. Publicly shared files remain accessible to anyone with the link. Members can join by invitation only.\n\nThe change is permanent and cannot be undone.\n\nAre you sure you want to convert {displayName} to a group chat?',
    },
    alertNo: {
    ...
    convertFailed: {
        ...
        defaultMessage: 'We were unable to convert {displayName} to a group chat.',
    },
    convertPrivateSuccess: {
        id: 'channel_info.convert_private_success',
        defaultMessage: '{displayName} is now a group chat.',
    },
    errorClose: {
...
const ConvertPrivate = ({canConvert, channelId, displayName}: Props) => {
    ...
    return (
        <OptionItem
            ...
            label={intl.formatMessage({id: 'channel_info.convert_private', defaultMessage: 'Convert to group chat'})}
            icon='lock-outline'
            type='default'

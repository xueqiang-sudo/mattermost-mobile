...
const Preferences = {
    ...
    THEMES: {
        ...
        quartz: {
            ...
            sidebarHeaderBg: '#ececec',
            sidebarHeaderTextColor: '#1f2228',
            sidebarTeamBarBg: '#edecec',
            onlineIndicator: '#3db887',
        ...
        onyx: {
            ...
            sidebarBg: '#111111',
            sidebarText: '#dfdfdf',
            sidebarUnreadText: '#dfdfdf',
            sidebarTextHoverBg: '#2a2a2a',
            sidebarTextActiveBorder: '#4a7ce8',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#111111',
            sidebarHeaderTextColor: '#dfdfdf',
            sidebarTeamBarBg: '#232323',
            onlineIndicator: '#3db887',
            awayIndicator: '#f5ab00',
            dndIndicator: '#d24b4e',
            mentionBg: '#fa5151',
            ...
            centerChannelColor: '#dfdfdf',
            dividerColor: '#2b2a2aff',
            newMessageSeparator: '#1adbdb',
            linkColor: '#5d89ea',
            buttonBg: '#4a7ce8',
            buttonColor: '#ffffff',
            errorTextColor: '#fa5151',
